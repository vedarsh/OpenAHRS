...
Icm45686_Handle_t imu;

Icm45686_Config_t imu_config;

Icm45686_ScaledData_t imu_scaled_data;
...
/* USER CODE BEGIN 0 */
/*
 * Initialise the IMU with parameters
 * ACCEL - 8G Limit
 * GYRO - 1000 dps Limit
 * ODR of both are 1Khz
 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, IMU_CS_Pin|MAG_CS_Pin|BME_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : IMU_CS_Pin MAG_CS_Pin BME_CS_Pin */
  GPIO_InitStruct.Pin = IMU_CS_Pin|MAG_CS_Pin|BME_CS_Pin;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
	...
	{
		//Set Flag of is_imu_data_available to true
